                    ...
                    <div className="form-group">
                        ...
                        <div className="form-body">
                            ...
                            <div className="form-group row">
                                ...
                                <input type="number" name="class" value="18" className="form-input col-md-6" value={props.class} />
                            </div>
                            {/* row birthdate */}
                            <div className="form-group row">
                            ...
                            <div className="form-group row">
                             ...
                             <div className="form-group row">
                                ...
                                <input type="file" id="myfile" name="myfile" multiple
                                 ...
                                 <label for="firstname" className="label-title col-sm-2">Document Number</label>
